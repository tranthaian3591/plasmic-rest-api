...
import sty from "./PlasmicButton.module.css"; // plasmic-import: wK-u6_ucROx/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: tlyUsUJcP3V/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: H0-NV0ApC9v/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___94Aje)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__d7V42)}
                role={"img"}
              />
            ),
